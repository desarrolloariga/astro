...
export const estadosRecepcionMetal: ConfigEstado = {
  borrador: { etiqueta: 'Borrador (sin cuadrar)', clases: 'bg-muted text-muted-foreground' },
  confirmada: { etiqueta: 'Confirmada', clases: 'bg-primary/10 text-primary' },
  cancelada: { etiqueta: 'Cancelada', clases: 'bg-destructive/10 text-destructive' },
}
