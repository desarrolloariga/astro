-- ============================================================
-- ARIGA — Migración 0014: engancha el motor de incentivos en el
-- momento de la venta.
--   - fn_registrar_venta / fn_confirmar_carrito ahora calculan el
--     descuento por desempeño ANTES de fijar el total, y otorgan
--     puntos (fn_calcular_puntos) después de registrar la venta.
-- Se reemplazan por completo (misma firma) para no romper a los
-- llamantes existentes en la aplicación.
-- ============================================================
